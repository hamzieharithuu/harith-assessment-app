...
@section('content')
    ...
    <div class="row widget-grid">
        <div class="col-xxl-6 col-sm-6 box-col-6 wow zoomIn">
            <div class="card">
                <div class="card-body">
                    Test
                </div>
